  ...
  if (step === "final" || !current) {
    return (
      <div>
        ...
        {/* Card prossimo passo */}
        <div className="mt-10 rounded-2xl border border-amber-500/40 bg-black/30 p-6 text-left backdrop-blur">
          <h3 className="font-serif text-2xl font-bold tracking-tight text-white">
            Prossimo passo
          </h3>
          <p className="mt-4 leading-relaxed text-slate-300">
            Ti contatterò entro 24 ore al numero che hai lasciato. Tieniti libero
            per una chiamata veloce di 20 minuti.
          </p>
        ...
        {/* FAQ */}
        <div className="mt-10">
          <h3 className="text-center font-serif text-2xl font-bold tracking-tight text-white">
...
export default function Grazie() {
  ...
  return (
    <div className={`${inter.variable} ${dmSerif.variable} w-full bg-gradient-to-b from-[#020b18] via-[#051525] to-[#0a1f35] font-sans text-slate-100`}>
      ...
      {/* MODAL QUIZ */}
      {quizOpen && (
        <div className="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto bg-black/90 px-6 py-10 backdrop-blur">
